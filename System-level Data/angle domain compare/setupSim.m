...
param.AvgDist = 1; % Average interference range
param.numInt = 2; % Number of interference
param.azIntVec = [-70+rand*100,-70+rand*100]; % Interference angle
param.targetIdx = 1;
...
hold on
% AGS
plot(tarAngle,param.PowAGSStatsdB);
% Plot labels
xlabel('Angle (degree)')
ylabel('Power (dB)')
